    ...
    public void onInitialize() {
        ...
        LootTableLoadingCallback.EVENT.register((resourceManager, lootManager, id, supplier, setter)->{
            if (id.equals(new Identifier("minecraft","chests/end_city_treasure"))){
                FabricLootPoolBuilder fabricLootPool = FabricLootPoolBuilder.builder().rolls(BinomialLootNumberProvider.create(1,0.3f)).withEntry(ItemEntry.builder(WEIRD_REALM_ITEM).build());
