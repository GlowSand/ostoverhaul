...
public class OstOverhaul implements ModInitializer {
    ...
    public static final Identifier WITHER_CHARGE_UP = new Identifier("ostoverhaul:withering_charge");
    public static SoundEvent WITHER_CHARGE = new SoundEvent(WITHER_CHARGE_UP);
    public static final Identifier WITHERING_ID = new Identifier("ostoverhaul:withering");
    public static SoundEvent WITHERING = new SoundEvent(WITHERING_ID);
    ...
    public void onInitialize() {
        ...
        Registry.register(Registry.SOUND_EVENT,WITHERING_ID,WITHERING);
        Registry.register(Registry.SOUND_EVENT,WITHER_CHARGE_UP,WITHER_CHARGE);
        ...
        ServerTickEvents.END_SERVER_TICK.register(server -> {
            ...
            if (ticksorsmthn[0] %20 == 0) {
                //shit ass code fix this when u can
